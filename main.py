...
general_aircraft.addCoefficients(cd0=0.03324, clMinD=0, cl0=0.6096)
...
motor.addMotorSpecs(paMax=32)              # placeholder pa_max
propeller.addPropellerSpecs(nEff=0.95)
...
wing.addCoefficients(aw=4.4063, ew=0.825, cm0w=-0.208, cl0w=0.62, alpha0w=round(-7.8/57.3, 4))

general_aircraft.addCoefficients(x_cg_cw=0.2834, x_ac_cw=0.25, cl0=0.6096, cd0=0.03324)
